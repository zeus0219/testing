...
(self.webpackChunk_N_E_ = self.webpackChunk_N_E_ || []).push([[94], {
  27895: function (e, t, i) {
    ...
    let c = {
      ...
      darkest: {
        color: a.r.colors.ui.darkest,
        text: "#fff"
      },
      dark: {
        color: a.r.colors.ui.dark,
        text: "#fff"
      },
      mediumWhite: {
      ...
      medium: {
        color: a.r.colors.ui.medium,
        text: a.r.colors.ui.light
      },
      grey: {
        color: a.r.colors.ui.light,
        text: a.r.colors.ui.light
      },
      darkGrey: {
        color: "#151718",
      ...
      cta: {
        color: a.r.colors.actions.cta,
        text: a.r.colors.actions.cta
      }
    };
    function p(e) {
      let {
      ...
      return t[1] === s.J.THEN || t[1] === s.J.OR ? (0, n.jsxs)(h, {
        "data-keys": !0,
        margin: r,
        style: {
    ...
    function d(e) {
      ...
      if ((0, r.useEffect)(() => {
        let e = new Image();
        e.src = "".concat(d, "/keys/key-").concat(i.toLowerCase(), ".svg#KEY-").concat(i), e.onload = () => p(!0);
      }, [d, i]), !i || i === s.J.THEN || i === s.J.OR) return null;
      let {
          text: h
        } = c[o],
        x = i.includes("W-") ? 40 : 16,
        m = ["dark", "darkest", "black", "medium", "mediumWhite", "darkGrey"].includes(o),
        ...
        g = (0, n.jsxs)("svg", {
          ...
          children: [m && (0, n.jsx)("rect", {
            ...
            xlinkHref: "".concat(d, "/keys/key-").concat(i.toLowerCase(), ".svg#KEY-").concat(i)
          })]
        });
      return u ? (0, n.jsx)(f, {
        style: {
    ...
    let h = o.ZP.span.withConfig({
        componentId: "sc-4b8cb7c5-0"
      })(["display:inline-grid;align-items:center;justify-content:center;grid-auto-flow:column;grid-gap:4px;margin:", ";color:", ";"], e => e.margin ? "0 6px" : "0", e => e.theme.colors.ui.dark),
      f = o.ZP.span.withConfig({
        componentId: "sc-4b8cb7c5-1"
  ...
  5901: function (e, t, i) {
    ...
    var s = i(84687),
      ...
      p = function (e) {
        ...
        (0, r.useEffect)(() => {
          ...
          function n() {
            clearTimeout(e), clearTimeout(t), C(!1), t = setTimeout(() => {
              g(!1);
            }, 600);
          }
          function r() {
            clearTimeout(e), document.querySelector('[data-tooltip-opened="true"]') ? (C(!0), g(!0)) : e = setTimeout(() => {
              g(!0), C(!0);
            }, 400);
          }
          if (i) return i.addEventListener("blur", n), i.addEventListener("mouseenter", r), i.addEventListener("mouseleave", n), i.addEventListener("click", n), () => {
            n(), i.removeEventListener("blur", n), i.removeEventListener("mouseenter", r), i.removeEventListener("mouseleave", n), i.removeEventListener("click", n);
          };
        }, [C, x]), (0, r.useEffect)(() => {
          if (v) {
            let e = () => C(!1),
            ...
            return null == t || t.addEventListener("scroll", e), null == i || i.addEventListener("scroll", e), () => {
              null == t || t.removeEventListener("scroll", e), null == i || i.removeEventListener("scroll", e);
            };
          }
        }, [v]), (0, r.useEffect)(() => {
          if (p) return;
          ...
          v && function () {
            ...
            switch (i) {
              case "top":
                r = t.top - 1.08 * n.height - 10 + s.top, a = t.left + t.width / 2 - n.width / 2 + s.left;
                break;
              case "right":
                r = t.top + t.height / 2 - 1.08 * n.height / 2 + s.top, a = t.right + 10 + s.left;
                break;
              case "bottom":
                r = t.top + t.height + 10 + s.top, a = t.left + t.width / 2 - n.width / 2 + s.left;
                break;
              case "left":
                r = t.top + t.height / 2 - 1.08 * n.height / 2 + s.top, a = t.left - n.width - 10 + s.left;
            }
            b({
              top: "".concat(r, "px"),
              left: "".concat(a, "px")
        ...
        return (0, n.jsxs)(n.Fragment, {
          children: [(0, r.cloneElement)(f, {
            "data-tooltip": x,
            ...(u ? {
              "data-tooltip-opened": !0
            } : {})
          }), L((e, i) => i ? (0, n.jsx)(c.Z, {
            children: (0, n.jsx)(d, {
              ref: w,
    ...
    let d = (0, o.ZP)(s.q.div).withConfig({
        componentId: "sc-f2ea0151-0"
      ...
      h = o.ZP.div.withConfig({
        componentId: "sc-f2ea0151-1"
      })(["display:flex;align-items:center;padding:", ";border-radius:7px;font-size:14px;border:0.5px solid ", ";background:linear-gradient(180deg,rgba(11,11,15,0.7) -1.79%,#000000 62.5%);box-shadow:0px 4px 25px rgba(0,0,0,0.25);backdrop-filter:blur(12px);", " & > span{margin-left:9px;}"], e => e.textOnly ? "2px 9px 4px" : "3px 6px 3px 9px", e => e.theme.colors.ui.medium, l.LH);
  },
  1242: function (e, t, i) {
    i.d(t, {
      LH: function () {
    ...
    var n = i(19453);
    let r = (0, n.iv)(["overflow:hidden;white-space:nowrap;text-overflow:ellipsis;"]),
      o = (0, n.iv)(["scrollbar-width:none;-ms-overflow-style:none;&::-webkit-scrollbar{display:none;}"]),
      a = (0, n.iv)(["font-variant-numeric:tabular-nums;letter-spacing:-0.4px;padding-right:1px;"]),
      s = (0, n.F4)(["from{opacity:0.2;}to{opacity:1;}"]),
      l = (0, n.F4)(["from{opacity:0;}to{opacity:1;}"]);
    (0, n.iv)(["opacity:0.2;animation:", " 0.16s forwards;"], s), (0, n.iv)(["opacity:0;animation:", " 0.16s forwards;"], l);
  },
  9271: function (e, t, i) {
    i.d(t, {
      Z: function () {
    ...
    let s = r.ZP.div.withConfig({
      componentId: "sc-5d598e6d-0"
    })(["position:relative;width:100%;max-width:1220px;padding:0 40px;margin:0 auto;", "{padding:0 40px;max-width:1130px;}", "{padding:0 20px;max-width:578px;}"], o.mq.desktopMedium, o.mq.tablet);
  },
  24152: function (e, t, i) {
      ...
      return (0, n.jsxs)(k, {
        children: [(0, n.jsxs)(u, {
          ...
          children: [(0, n.jsx)(l.Z, {
            ...
            label: (0, n.jsxs)(n.Fragment, {
              children: ["Start your trial ", (0, n.jsx)(a.Z, {
                keys: [s.J.T],
                theme: "mediumWhite"
              })]
            }),
            children: (0, n.jsx)("div", {
              children: (0, n.jsx)(y, {
                onClick: () => window.location.href = "".concat(c.Z.get("url")).concat(p._.signup),
                children: (0, n.jsxs)("span", {
                  children: [(0, n.jsx)(o, {
                    color: h.r.colors.ui.light
                  }), "Start your trial"]
                })
              })
            })
          ...
          children: x.slice(0, 2).map(e => (0, n.jsx)(v, {
            href: e.href,
            children: e.label
          }, e.label))
        })]
    ...
    let u = r.ZP.div.withConfig({
        componentId: "sc-424c477-0"
      })(["display:flex;align-items:center;"]),
      g = r.ZP.span.withConfig({
        componentId: "sc-424c477-1"
      })(["display:none;", "{display:initial;}"], d.mq.tablet),
      w = r.ZP.span.withConfig({
        componentId: "sc-424c477-2"
      })(["", "{display:none;}"], d.mq.tablet),
      v = (0, r.ZP)(f.Z).withConfig({
        componentId: "sc-424c477-3"
      })(["position:relative;top:1px;margin-left:40px;color:", ";transition:color 0.2s ease;&:hover{color:", ";}", "{margin-left:26px;}"], e => e.theme.colors.ui.light, e => e.theme.colors.ui.lightest, d.mq.tablet),
      C = (0, r.F4)(["0%{transform:translateX(0%);}5%{transform:translateX(-2px) rotate(-2deg);}10%{transform:translateX(2px) rotate(2deg);}15%{transform:translateX(-1px) rotate(-1deg);}20%{transform:translateX(1px) rotate(1deg);}25%{transform:translateX(0%);}100%{transform:translateX(0%);}"]),
      y = r.ZP.button.withConfig({
        componentId: "sc-424c477-4"
      })(["position:relative;display:flex;flex-direction:row;justify-content:center;align-items:center;padding:8px 16px 8px 12px;min-width:152px;gap:4px;border-radius:28px;background:radial-gradient( 61.35% 50.07% at 48.58% 50%,rgb(0 0 0) 0%,rgb(255 255 255 / 4%) 100% );box-shadow:0px 0px 0px 0.5px rgba(134,143,151,0.2) inset,1px 1px 0px -0.5px rgba(134,143,151,0.4) inset,-1px -1px 0px -0.5px rgba(134,143,151,0.4) inset;padding:8px 17px 8px 12px;height:32px;min-width:136px;font-weight:600;font-size:14px;line-height:17px;text-align:center;color:#fff;span{display:flex;flex-direction:row;align-items:center;position:relative;z-index:1;gap:8px;}&::after{content:'';position:absolute;background:radial-gradient(61.35% 50.07% at 48.58% 50%,#000 0%,#181818 100%);box-shadow:0px 0px 0px 0.5px rgba(134,143,151,0.2) inset,1px 1px 0px -0.5px rgba(134,143,151,0.4) inset,-1px -1px 0px -0.5px rgba(134,143,151,0.4) inset,0 0px 3px rgba(255,255,255,0.1);position:absolute;border-radius:28px;left:0;top:0;width:100%;height:100%;opacity:0;transition:opacity 0.2s;}&:hover{&::after{opacity:1;}}&:hover svg{animation:", " 2s linear infinite;animation-delay:4s;}svg path,svg circle{transform-origin:center;stroke-width:1.5;transition:all 0.4s ease;}&:hover svg *{stroke:white;}&:hover svg circle{transform:scale(1.2);opacity:0;}&:hover svg path{transform:scale(1.6) translateY(-0.5px);}"], C),
      b = (0, r.ZP)(e => {
        let {
          color: t = "#fff",
          size: i = 18,
        ...
        componentId: "sc-424c477-5"
      })([".touch{stroke:white;stroke-dashoffset:23;stroke-dasharray:23;opacity:0;transition:all 1s ease;}"]),
      k = r.ZP.nav.withConfig({
        componentId: "sc-424c477-6"
      })(["position:absolute;max-width:1220px;padding:0 40px;margin:0 auto;left:0;right:0;display:flex;justify-content:space-between;align-self:center;width:100%;top:40px;z-index:100;", "{top:36px;}", "{padding:0 20px;}"], d.mq.tablet, d.mq.phablet),
      j = r.ZP.div.withConfig({
        componentId: "sc-424c477-7"
      })(["display:flex;align-items:center;font-size:14px;", "{display:none;}"], d.mq.tablet),
      L = r.ZP.div.withConfig({
        componentId: "sc-424c477-8"
      })(["", "{display:none;}"], d.mq.tabletUp),
      Z = r.ZP.a.withConfig({
        componentId: "sc-424c477-9"
