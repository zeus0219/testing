(self.webpackChunk_N_E_ = self.webpackChunk_N_E_ || []).push([
  [179],
  {
    ...
    95014: function (e, t, r) {
      ...
      async function $(e) {
            ...
            JSON.stringify({
              "props": {
                "pageProps": {
                  ...
                  "stats": { "eps": null, "revenue": null, "revenueBeat": null }
                },
                "__N_SSG": true
              },
              "page": "/",
        ...
        if (
          ...
          (a = (0, R.getURL)()),
          (0, D.hasBasePath)(a) && (a = (0, k.removeBasePath)(a)),
          o.scriptLoader)
        ) {
          let { initScriptLoader: e } = r(28263);
          e(o.scriptLoader);
        }
    ...
    14650: function (e, t, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }), r(64411);
      let n = r(95014);
      (window.next = {
        version: n.version,
        get router() {
    ...
    55938: function (e, t, r) {
      ...
      class X {
        ...
        async change(e, t, r, n, o) {
          ...
          let k, B;
          if (!(0, T.isLocalURL)(t)) return z({ url: t, router: this }), !1;
          let U = 1 === n._h;
          ...
          if (!U && this.onlyAHashChange(Q) && !Z) {
            ...
            try {
              ...
              throw (
                ((0, u.default)(e) &&
                  e.cancelled &&
                  X.events.emit("routeChangeError", e, Q, J),
                e)
              );
            }
          ...
          try {
            ...
            if (
              ...
              if (a.props.pageProps && a.props.pageProps.__N_REDIRECT) {
                ...
                if (
                  ...
                  let { url: o, as: a } = D(this, t, t);
                  return this.change(e, o, a, n);
                }
                return z({ url: t, router: this }), new Promise(() => {});
              }
              if (
                ((q.isPreview = !!a.props.__N_PREVIEW), a.props.notFound === H)
              ) {
                let e;
                try {
            ...
            if (
              ...
              if (a.error)
                throw (
                  (U || X.events.emit("routeChangeError", a.error, Q, J),
                  a.error)
                );
              U || X.events.emit("routeChangeComplete", r, J),
        ...
        constructor(
          ...
          window.addEventListener("popstate", this.onPopState),
            U && (window.history.scrollRestoration = "manual");
        }
      }
