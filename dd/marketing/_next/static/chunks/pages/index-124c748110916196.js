...
(self.webpackChunk_N_E_ = self.webpackChunk_N_E_ || []).push([[405], {
  ...
  56494: function (A, t) {
    ...
    t.Z = {
      ...
      height: 1260,
      width: 2400,
      blurDataURL: "data:image/jpeg;base64,",
      blurWidth: 8,
      blurHeight: 4
    };
  },
  ...
  19016: function (A, t, e) {
    ...
    let s = n.ZP.button.withConfig({
      ...
      o = n.ZP.button.withConfig({
        componentId: "sc-411481a2-1"
      })(["position:relative;display:flex;align-items:center;padding:4px 33px 5px 33px;border-radius:43px;font-size:16px;font-weight:600;line-height:19px;text-align:center;display:flex;align-items:center;justify-content:center;width:100%;max-width:194px;height:36px;white-space:nowrap;span{position:relative;z-index:1;}", "{font-size:19px;font-weight:600;width:230px;max-width:230px;height:46px;}"], a.mq.tablet),
      r = (0, n.ZP)(o).withConfig({
  ...
  56956: function (A, t, e) {
    ...
    t.Z = function (A) {
      ...
      return (0, s.useEffect)(() => {
        ...
        if (f) return A(), window.addEventListener("scroll", A), window.addEventListener("resize", A), () => {
    ...
    let c = r.ZP.div.withConfig({
      ...
      })(["position:sticky;top:", "px;min-height:initial;height:", ";display:flex;align-items:center;justify-content:center;overflow-x:hidden;width:100%;z-index:1;", ";", "{", "}"], A => A.top || 0, A => A.cover ? "100vh" : "initial", A => A.cover && "overflow-y: hidden;", l.mq.phablet, A => A.overflowVisisble && "overflow: visible;");
  },
  58168: function (A, t, e) {
    ...
    var i = e(19453),
      n = e(33178);
    let a = i.ZP.p.withConfig({
        componentId: "sc-1578630c-0"
      })(["font-weight:normal;font-size:18px;line-height:132%;", "{font-size:18px;}", "{font-size:16px;}"], n.mq.desktopMedium, n.mq.phone),
      s = i.ZP.p.withConfig({
        componentId: "sc-1578630c-1"
      })(["font-style:normal;font-weight:600;font-size:22px;line-height:110%;@media (max-height:780px) and (max-width:1440px){line-height:130%;font-size:19px;}", "{line-height:130%;font-size:19px;}", "{font-size:16px;}"], n.mq.desktopMedium, n.mq.phoneSmall);
    t.Z = {
      regular: a,
      semibold: s
    };
  ...
  9276: function (A, t, e) {
    ...
    var i = e(52322),
      ...
      j = e.n(v),
      z = e(93146);
    let D = j()(() => Promise.resolve().then(e.bind(e, 10035)).then(A => A.ResponsiveLine), {
        loadableGenerated: {
          webpack: () => [10035]
        },
        ssr: !1
      }),
      O = "'FeyCalibre','-apple-system','BlinkMacSystemFont', 'San Francisco','Helvetica Neue','Helvetica','Ubuntu','Roboto', 'Noto','Segoe UI','Arial',sans-serif",
    ...
    function S(A) {
      ...
      }, [o]), e) ? (0, i.jsx)(P, {}, 1) : (0, i.jsx)(P, {
        ref: o,
        children: (0, i.jsx)(Z, {
          data: [{
            id: "spark-chart",
            data: t,
            color: "url(#graphDefault)"
          }],
          width: a
        })
      });
    ...
    (0, p.iv)(["opacity:0;animation:", " 0.5s forwards;"], (0, p.F4)(["from{opacity:0;}to{opacity:0.5;}"]));
    let P = p.ZP.div.withConfig({
        componentId: "sc-ed1f1067-0"
      })(["display:flex;align-items:center;position:relative;height:100%;width:100%;will-change:opacity;opacity:0;", " svg{overflow:visible;}"], U),
      L = A => {
        let {
            point: t,
            points: e,
        ...
        function d(A) {
          let t = l.current.getBoundingClientRect(),
            i = A.clientX - t.x - 8;
          return e.reduce((A, t) => Math.abs(t.x - i) < Math.abs(A.x - i) ? t : A, null == e ? void 0 : e[0]);
        }
        return (0, i.jsx)("g", {
          ...
          children: (0, i.jsx)("rect", {
            ...
            onPointerUp: function (A) {
              l.current.releasePointerCapture(A.pointerId), null == s || s(null);
            },
    ...
    (0, p.F4)(["0%{transform:translateX(0%);}5%{transform:translateX(-2px) rotate(-2deg);}10%{transform:translateX(2px) rotate(2deg);}15%{transform:translateX(-1px) rotate(-1deg);}20%{transform:translateX(1px) rotate(1deg);}25%{transform:translateX(0%);}100%{transform:translateX(0%);}"]);
    var A5 = e(30458),
      A4 = e(91446),
      A3 = e(64251),
      A8 = e(9271),
    ...
    var tY = e(1242);
    p.ZP.div.withConfig({
      componentId: "sc-ffaf8dad-0"
    })(["color:", ";opacity:0.64;padding:16px 16px 0;font-size:14px;"], A => A.theme.colors.ui.light);
    p.ZP.div.withConfig({
      componentId: "sc-ffaf8dad-5"
    })(["font-size:12px;display:flex;justify-content:flex-end;"]), p.ZP.div.withConfig({
      componentId: "sc-ffaf8dad-6"
    })(["margin-left:16px;font-size:16px;min-width:48px;text-align:right;", " & > strong{color:", ";}"], tY.lN, A => "true" === A.highlight ? "#fff" : A.theme.colors.ui.light);
    var tX = e(27895);
    p.ZP.div.withConfig({
      componentId: "sc-15f38c4f-2"
    })(["display:none;", "{display:block;}"], I.mq.tablet);
    var ew = e(56956);
    var eL = e(75512);
    p.ZP.div.withConfig({
      componentId: "sc-c716dd4f-22"
    ...
    var ny = {
        ...
        height: 469,
        width: 750,
        blurDataURL: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAFCAMAAABPT11nAAAABlBMVEUeHiIXFxxBu/leAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAG0lEQVR4nGNgZGBkZGRkAEEwQGHApBgZGUAEAAH4ABeMBTspAAAAAElFTkSuQmCC",
        blurWidth: 8,
        blurHeight: 5
      },
      nI = {
        ...
        height: 938,
        width: 1500,
        blurDataURL: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAFCAMAAABPT11nAAAABlBMVEUYGBwfHyTmngNfAAAACXBIWXMAABYlAAAWJQFJUiTwAAAAFklEQVR4nGNggANGMIAxwCJwggEsAAABgQAQaUcUfAAAAABJRU5ErkJggg==",
        blurWidth: 8,
        blurHeight: 5
      },
      nv = {
        ...
        height: 1876,
        width: 3e3,
        blurDataURL: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAFCAMAAABPT11nAAAABlBMVEUXFxweHiMTJeiOAAAACXBIWXMAACxLAAAsSwGlPZapAAAAGklEQVR4nGNgYGRgYAATjGCAwoBJgcQYGBgAAeYAEw1WBD4AAAAASUVORK5CYII=",
        blurWidth: 8,
        blurHeight: 5
      },
      nj = {
        ...
        height: 469,
        width: 750,
        blurDataURL: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAFCAMAAABPT11nAAAABlBMVEUaGyAWFhs+fjJmAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAGUlEQVR4nGNgQABGRgYGRggLxoAIQmhGBgAA1gALCRmH0AAAAABJRU5ErkJggg==",
        blurWidth: 8,
        blurHeight: 5
      },
      nz = {
        ...
        height: 938,
        width: 1500,
        blurDataURL: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAFCAMAAABPT11nAAAABlBMVEUaGyAXFxy4w/yzAAAACXBIWXMAABYlAAAWJQFJUiTwAAAAGklEQVR4nGNgQABGRhACs8AIgiEiDIyMjIwAAQUADsPSvOcAAAAASUVORK5CYII=",
        blurWidth: 8,
        blurHeight: 5
      },
      nD = {
        ...
        height: 1876,
        width: 3e3,
        blurDataURL: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAFCAMAAABPT11nAAAABlBMVEUaGyAWFxy5AZaEAAAACXBIWXMAACxLAAAsSwGlPZapAAAAHElEQVR4nGNgQABGRgYGRggLwgBjiAgDIyMjIwAA5wANEQj73QAAAABJRU5ErkJggg==",
        blurWidth: 8,
        blurHeight: 5
      },
      nO = function () {
    ...
    let nk = p.ZP.div.withConfig({
      componentId: "sc-fe3fc0e9-0"
    })(["position:absolute;left:0;top:0;width:100%;height:100%;overflow:hidden;padding:30px 60px 0 65px;flex:1;", "{padding:20px 40px 0 25px;}", "{padding:12px 40px 0 28px;}"], I.mq.desktopSmall, I.mq.tablet);
    function nM() {
      ...
      return (0, n.useEffect)(() => {
        let A = new window.Date(),
          ...
          i = A.getDate();
        t(["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"][A.getDay()]), a(e), o(i);
      }, []), (0, i.jsxs)("div", {
        children: [(0, i.jsx)(nS, {
    ...
    let nS = p.ZP.div.withConfig({
        componentId: "sc-fe3fc0e9-1"
      })(["font-weight:600;font-size:16.6667px;line-height:20px;", "{font-size:14.8px;}", "{line-height:8px;font-size:8px;}"], I.mq.desktopSmall, I.mq.tablet),
      nZ = p.ZP.div.withConfig({
        componentId: "sc-fe3fc0e9-2"
      })(["font-size:11.4583px;line-height:14px;color:", ";", "{font-size:10.17px;}", "{line-height:7px;font-size:6px;}"], A => A.theme.colors.ui.light, I.mq.desktopSmall, I.mq.tablet);
    function nR(A) {
      let {
        progress: t
      } = A;
    ...
    let nU = p.ZP.div.withConfig({
      componentId: "sc-213d6256-0"
    })(["position:relative;width:100%;height:100%;display:block;backface-visibility:hidden;overflow:hidden;will-change:border-radius;", "{display:none;}"], I.mq.tablet);
    var nP = function (A) {
      let {
          progress: t
        } = A,
    ...
    let nL = p.ZP.div.withConfig({
      componentId: "sc-c387fc9f-0"
    })(["position:relative;width:100%;height:100%;display:block;backface-visibility:hidden;overflow:hidden;", "{display:none;}"], I.mq.desktopSmallUp);
    var nV = e(43984),
      nH = function () {
        return (0, i.jsxs)(i.Fragment, {
          children: [(0, i.jsx)(nG, {
            children: (0, i.jsxs)(nF, {
              onClick: () => window.location.href = "".concat(y.Z.get("url")).concat(A3._.signup),
              "aria-label": "Submit request",
              children: ["Press ", (0, i.jsx)(tX.Z, {
                keys: [tU.J.T],
                theme: "mediumWhite"
    ...
    let nF = p.ZP.button.withConfig({
        componentId: "sc-3bc61693-0"
      })(["display:flex;align-items:center;font-weight:600;font-size:14px;line-height:132%;text-align:center;color:", ";transition:color 0.2s ease;& > span{margin:0 4px;transition:color 0.2s ease;}&:hover,&:focus{color:#fff;}", "{display:none;}"], A => A.theme.colors.ui.light, I.mq.tablet),
      nG = p.ZP.div.withConfig({
        componentId: "sc-3bc61693-1"
      })(["", "{display:none;}"], I.mq.tablet),
      nT = p.ZP.div.withConfig({
        componentId: "sc-3bc61693-2"
      })(["", "{display:none;}"], I.mq.tabletUp);
    var nN = {
      ...
      nY = {
        ...
        height: 410,
        width: 760,
        blurDataURL: "data:image/jpeg;base64,",
        blurWidth: 8,
        blurHeight: 4
      },
      nJ = {
      ...
      nK = {
        ...
        height: 410,
        width: 760,
        blurDataURL: "data:image/jpeg;base64,",
        blurWidth: 8,
        blurHeight: 4
      },
      nW = {
      ...
      nq = {
        ...
        height: 410,
        width: 760,
        blurDataURL: "data:image/jpeg;base64,",
        blurWidth: 8,
        blurHeight: 4
      },
      n$ = {
      ...
      n0 = {
        ...
        height: 410,
        width: 760,
        blurDataURL: "data:image/jpeg;base64,",
        blurWidth: 8,
        blurHeight: 4
      },
      n7 = {
    ...
    let n2 = (0, p.F4)(["0%{opacity:0;}5%{opacity:1;}50%{transform:translateX(94px);opacity:1;}52%{transform:translateX(96px);opacity:0;}100%{opacity:0;}"]),
      n4 = (0, p.F4)(["0%{opacity:0;}15%{opacity:0;transform:translateX(30px) rotate(-240deg) scale(0.5);}50%{transform:translateX(94px) rotate(-60deg) scale(1);opacity:1;}55%{transform:translateX(96px) rotate(0deg) scale(0.4);opacity:0;}100%{opacity:0;}"]),
      n6 = (0, p.F4)(["0%{box-shadow:0 2px 6px black,0 0 2px rgba(182,177,239,0),0 0 2px rgba(224,172,131,0);}50%{box-shadow:0 2px 2px rgba(0,0,0,0),-2px 0 6px rgba(182,177,239,0.3),2px 0 6px rgba(224,172,131,0.3);}100%{box-shadow:0 2px 6px black,0 0 2px rgba(182,177,239,0),0 0 2px rgba(224,172,131,0);}"]),
      n3 = p.ZP.span.withConfig({
        componentId: "sc-773c9270-0"
      })(["width:21px;height:21px;position:absolute;top:-11px;left:36px;filter:blur(0.5px);transform-origin:center;animation:", " 8s linear infinite;&::before,&::after{content:'';position:absolute;}&::before{width:1px;height:100%;left:10px;background:linear-gradient(to bottom,transparent,rgba(224,173,135,0.8),transparent);}&::after{width:100%;height:1px;top:10px;background:linear-gradient(to left,transparent,rgba(224,173,135,0.8),transparent);}"], n4),
      n8 = p.ZP.span.withConfig({
        componentId: "sc-773c9270-1"
      })(["position:relative;margin-left:4px;top:-1px;font-size:13px;line-height:17px;"]),
      n9 = p.ZP.button.withConfig({
        componentId: "sc-773c9270-2"
      })(["padding:0px 13px 0px 8px;margin-bottom:22px;color:#e6e6e6;z-index:1;position:relative;display:flex;-webkit-box-align:center;align-items:center;-webkit-box-pack:justify;justify-content:space-between;padding:5px 15px 5px 8px;border-radius:99px;background:linear-gradient(black,black) padding-box,linear-gradient(to right,rgba(182,177,239,0.2),rgba(224,172,131,0.2)) border-box;border:1px solid transparent;box-shadow:0 2px 8px -1px rgba(0,0,0,0.6);transition:all 0.6s ease;cursor:pointer;-webkit-tap-highlight-color:transparent;&::before{content:'';position:absolute;top:-1px;left:14px;height:1px;width:32px;background:linear-gradient(to right,transparent,rgba(255,255,255,0.16));animation:", " 8s linear infinite;mix-blend-mode:difference;}&:hover{animation:", " 2.2s linear infinite;}&:hover::before{opacity:0;animation:stop;}&:hover ", "{opacity:0;animation:stop;}& text{position:relative;margin-left:4px;top:-1px;font-size:13px;line-height:17px;}"], n2, n6, n3);
    function aA() {
      let [A, t] = (0, n.useState)(!1),
        e = (0, n.useRef)(null),
        a = (0, q.useIsClient)(),
        s = A => {
          A.preventDefault(), t(!1), e.current.src = "https://player.vimeo.com/video/893918505?h=7c1acb90f0&loop=0";
        };
      return (0, n.useEffect)(() => {
        if (A) {
          let A = A => {
      ...
      }, [A, s]), (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsxs)(n9, {
          onClick: () => {
            t(!0), e.current.contentWindow.postMessage({
              method: "play"
            }, "*");
          },
    ...
    let at = p.ZP.button.withConfig({
        componentId: "sc-773c9270-3"
      ...
      ae = p.ZP.div.withConfig({
        componentId: "sc-773c9270-4"
    ...
    function ar() {
      let [A, t] = (0, h.YD)({
        ...
        [g, p] = (0, n.useState)(!1);
      (0, n.useEffect)(() => {
        l.current && (l.current.style.transform = "translateY(".concat(r, "vh)"));
      }, [o, s, r, l]), (0, n.useEffect)(() => {
        console.log(a, '4444444444', window.scrollY);
        let A = () => c((0, eL.uZ)(window.scrollY, 0, 500));
        if (a) return A(), window.addEventListener("scroll", A), () => window.removeEventListener("scroll", A);
      }, [a]), (0, n.useEffect)(() => {
        var A;
        A = () => {
          p(!0);
      ...
      return (0, n.useEffect)(() => {
        ...
        children: (0, i.jsxs)(A8.Z, {
          children: [(0, i.jsx)(al, {
            ...
            style: {
              animation: g ? "fadein 4s 0.3s forwards" : "none"
            },
            children: [(0, i.jsx)(ay, {
              tabIndex: -1,
              style: {
                transform: "translateY(-".concat(d / 300, "px)")
              },
              children: (0, i.jsxs)(aI, {
                ref: l,
                children: [(0, i.jsx)(ao, {}), (0, i.jsx)(av, {
                  src: nY,
                  srcMedium: nJ,
                  srcLarge: n_,
                  alt: ""
    ...
    let al = p.ZP.div.withConfig({
        componentId: "sc-773c9270-11"
      })(["display:flex;align-items:center;justify-content:center;", "{z-index:100;}"], I.mq.tablet),
      ad = () => (0, i.jsx)("svg", {
        viewBox: "0 0 75 21",
        fill: "none",
        xmlns: "http://www.w3.org/2000/svg",
    ...
    function ap(A) {
      ...
      return (0, n.useEffect)(() => {
        let A = 18,
          ...
          r = 0.825,
          l = 0.765;
        t >= 960 && (A = 38, i = 12, e >= 750 && (A = 24, i = 18), e >= 800 && (A = 18, i = 20), e >= 850 && (A = 14, i = 24), e >= 900 && (A = 12, i = 28), e >= 950 && (A = 12, i = 35), e >= 1100 && (A = 12, i = 40)), t >= 1440 && e <= 780 && (A = 31, i = 18), t <= 960 && (n = 61, s = 55, o = 198, r = 0.835, l = 0.88), t <= 768 && (n = 67, s = 38, o = 290, r = 0.772, l = 1, A = 12, i = 13), t <= 540 && (n = 73.5, s = 29, o = 190, r = 0.82, l = 1, A = 18, i = 10, e > 800 && (i = 8)), t <= 440 && (A = 20, i = 24), t <= 375 && (n = 74, s = 26, o = 290, r = 0.77, l = 1, A = 30, i = 20, e < 700 && (A = 30, i = 20)), t <= 360 && (n = 74, s = 28, o = 290, r = 0.81, l = 1), t <= 320 && (s = 22.6, n = 74, o = 480, r = 0.78, l = 1, A = 30, i = 16, e > 490 && (A = 30, i = 22)), a({
          rX: n,
          tY: s,
          tZ: o,
          sX: r,
    ...
    function ax() {
      ...
      return (0, n.useEffect)(() => {
        let e = 1800;
        t <= 960 && (e = 2e3), t <= 540 && (e = 1500), t <= 400 && (e = 1280, A > 700 && (e = 1430)), t <= 320 && (e = 1150), A <= 780 && t >= 960 && (e = 1650), A >= 1100 && (e = 2050), g(e);
      }, [t, A]), (0, i.jsx)(ew.Z, {
        cover: !0,
        overflowVisisble: !0,
        height: "".concat(c, "px"),
            ...
            (() => {
              if (g > 0.1 && (p.current.style.animationDuration = "0s"), h.current && x.current && m.current && f.current) {
                let A = t > 768 ? 1.1 : 1,
                  ...
                  u = (0, eL.uZ)((1 - g) * l, 0, l);
                h.current.style.transform = "translateY(".concat(u,
                // t > 960 ? u-l+1 : -1*u+1,
                "vh)"), t > 768 && (x.current.style.transform = "translate3d(0px, -".concat(n + 14, "px, ").concat(d, "px) rotateX(-").concat(i, "deg) scale3d(0.86, 0.66, 1)"), x.current.style.opacity = g > 0 ? "0.7" : "0"), m.current.style.opacity = g > 0.35 ? "1" : "0", f.current.style.transform = "translate3d(0px, -".concat(n, "px, ").concat(d, "px) rotateX(-").concat(i, "deg) scale3d(").concat(c, ", ").concat(p, ", 1)");
              }
            })();
          }, [t, A, g, l, d, h, x, m, f, e, a, o, r]), (0, i.jsx)(ab, {
            "aria-hidden": "true",
            ref: p,
            tabIndex: -1,
        ...
        notSticky: A => {
          ...
          return (0, n.useEffect)(() => {
            (() => {
              ...
              a.current.style.opacity = "".concat((e - A) * 6), e > 0.1 && (a.current.style.animationDuration = "0s");
            })();
          }, [e, a, t]), (0, i.jsx)(i.Fragment, {
            children: (0, i.jsx)("div", {
              style: {
                position: "relative",
                zIndex: e < 0.1 ? 1 : 0
    ...
    let am = p.ZP.div.withConfig({
        componentId: "sc-773c9270-12"
      })(["top:-18vh;position:relative;", "{top:-24vh;margin-bottom:-4vh;}", "{top:-28vh;margin-bottom:-12vh;}", "{top:-33vh;margin-bottom:-18vh;}@media (max-height:700px){top:-30vh;}@media (max-height:760px) and (min-width:960px){top:-14vh;padding-bottom:4vh;}@media screen and (min-height:950px){top:-21vh;margin-bottom:-6vh;}@media screen and (min-height:1050px){top:-26vh;margin-bottom:-10vh;}"], I.mq.desktopSmall, I.mq.tablet, I.mq.phablet),
      af = p.ZP.section.withConfig({
        componentId: "sc-773c9270-13"
      })(["background:", ";"], A => A.theme.colors.ui.black),
      au = p.ZP.div.withConfig({
        componentId: "sc-773c9270-14"
      })(["display:flex;align-items:center;justify-content:center;"]),
      aE = p.ZP.div.withConfig({
        componentId: "sc-773c9270-15"
      })(["position:relative;width:100%;text-align:center;display:flex;flex-direction:column;justify-content:center;align-items:center;p{max-width:480px;margin:0 auto;}h2:first-of-type{", "{display:none;}}h2:last-of-type{display:none;", "{display:block;}}"], I.mq.tablet, I.mq.tablet),
      aC = p.ZP.div.withConfig({
        componentId: "sc-773c9270-16"
      })(["position:relative;max-width:458px;text-align:center;opacity:0;animation:fadein 3.6s 1.2s forwards;top:8vh;h2{margin-bottom:16px;}", "{top:0;padding:0 18px;}", "{top:8vh;}"], I.mq.tablet, I.mq.phoneSmall),
      ab = p.ZP.div.withConfig({
        componentId: "sc-773c9270-17"
      })(["position:relative;pointer-events:none;width:100%;will-change:transform;", "{max-width:335px;}"], I.mq.phablet),
      aw = p.ZP.div.withConfig({
        componentId: "sc-773c9270-18"
      })(["position:relative;transform-origin:50% 50%;transform-style:preserve-3d;perspective:2000px;"]),
      aB = (0, p.ZP)(V.Z.h1).withConfig({
        componentId: "sc-773c9270-19"
      })(["max-width:593px;margin-bottom:21px;", "{max-width:512px;}", "{max-width:320px;margin-bottom:45px;span{display:block;}}"], I.mq.tablet, I.mq.phablet),
      aQ = p.ZP.div.withConfig({
        componentId: "sc-773c9270-20"
      })(["opacity:0;pointer-events:none;"]),
      ay = p.ZP.div.withConfig({
        componentId: "sc-773c9270-21"
      })(["position:absolute;left:0;right:0;max-width:760px;margin:0 auto;height:100vh;display:flex;align-items:center;justify-content:center;pointer-events:none;will-change:transform;", "{max-width:660px;}", "{max-width:487px;}", "{max-width:335px;}"], I.mq.desktopSmall, I.mq.tablet, I.mq.phablet),
      aI = p.ZP.div.withConfig({
        componentId: "sc-773c9270-22"
      })(["position:relative;width:760px;display:flex;img{width:100%;height:100%;}"]),
      av = (0, p.ZP)(H.Z).withConfig({
        componentId: "sc-773c9270-23"
      })(["mask-image:url(", ");mask-size:760px 410px;", "{mask-size:100%;}"], "/dd/marketing/_next/static/media/macbook-mask.88a7ca93.png", I.mq.desktopSmall),
      aj = (0, p.ZP)(H.Z).withConfig({
        componentId: "sc-773c9270-24"
      })(["position:absolute;mask-image:url(", ");mask-size:760px 410px;", "{mask-size:100%;}"], "/dd/marketing/_next/static/media/screen-mask.925d359b.png", I.mq.desktopSmall),
      az = p.ZP.div.withConfig({
        componentId: "sc-773c9270-25"
      })(["position:absolute;top:0;left:-3px;width:100%;height:100%;", "{left:-2px;}", "{left:-1px;}"], I.mq.tablet, I.mq.phablet),
      aD = p.ZP.div.withConfig({
        componentId: "sc-773c9270-26"
      })(["position:absolute;top:0;left:0;width:100%;opacity:0;animation:fadein 2s 2s forwards;"]),
      aO = p.ZP.div.withConfig({
        componentId: "sc-773c9270-27"
      })(["position:absolute;left:0;top:0;right:0;height:100%;width:100%;max-width:750px;margin:0 auto;z-index:1;transition:opacity 0.2s;box-shadow:0 0 30px ", ";", "{max-width:666px;max-height:357px;}", "{max-width:487px;height:304.54px;", "}", "{max-width:335px;height:208px;}"], A => A.theme.colors.ui.black, I.mq.desktopSmall, I.mq.tablet, A => A.hideOnMobile && "display: none;", I.mq.phablet),
      ak = p.ZP.div.withConfig({
        componentId: "sc-773c9270-28"
      })(["position:relative;width:100%;max-width:750px;background:#000;display:flex;justify-content:center;align-items:center;z-index:1;margin:0 auto;z-index:10;border-radius:11px;will-change:transform;", "{max-width:640px;overflow:visible;}", "{max-width:487px;height:304.54px;}", "{max-width:335px;height:auto;}"], I.mq.desktopSmall, I.mq.tablet, I.mq.phablet),
      aM = p.ZP.div.withConfig({
        componentId: "sc-773c9270-29"
      })(["max-width:446px;text-align:center;margin:32px auto 0;color:", ";", "{max-width:330px;}"], A => A.theme.colors.labels.highlight, I.mq.phone),
      aS = p.ZP.div.withConfig({
        componentId: "sc-773c9270-30"
      })(["display:flex;justify-content:space-between;align-items:center;width:100%;margin:45px auto;overflow:hidden;"]),
      aZ = p.ZP.div.withConfig({
        componentId: "sc-773c9270-31"
      })(["opacity:0;min-width:75px;&:last-of-type{min-width:84px;}", "{min-width:64px;&:last-of-type{min-width:71px;}}", "{min-width:56px;&:last-of-type{min-width:61px;}}"], I.mq.tablet, I.mq.phone),
      aR = (0, p.ZP)(aZ).withConfig({
        componentId: "sc-773c9270-32"
      })(["transform:translateX(3px) scale(0.98);transition:transform 0.6s cubic-bezier(0.25,0.4,0.4,1) ", ",opacity 0.6s ", ";"], A => A.delay, A => A.delay);
    (0, p.ZP)(aZ).withConfig({
      componentId: "sc-773c9270-33"
    })(["transition:opacity 0.6s ", ";"], A => A.delay);
    let aU = (0, p.ZP)(aZ).withConfig({
      componentId: "sc-773c9270-34"
    })(["transform:translateX(-3px) scale(0.98);transition:transform 0.6s cubic-bezier(0.25,0.4,0.4,1) ", ",opacity 0.6s ", ";"], A => A.delay, A => A.delay);
    p.ZP.div.withConfig({
      componentId: "sc-773c9270-35"
    })(["transform:translateX(-3px) scale(0.98);opacity:0;transition:transform 0.6s cubic-bezier(0.25,0.4,0.4,1) ", ",opacity 0.6s ", ";"], A => A.delay, A => A.delay), p.ZP.div.withConfig({
      componentId: "sc-773c9270-36"
    })(["transform:translateY(-9px) scale(0.98);opacity:0;transition:transform 0.6s cubic-bezier(0.25,0.4,0.4,1) ", ",opacity 0.6s ", ";"], A => A.delay, A => A.delay);
    var a5 = !0;
    function a2(A) {
      return (0, i.jsxs)(i.Fragment, {
  ...
  A.O(0, [655, 792, 357, 786, 624, 154, 707, 94, 525, 701, 572, 888, 774, 179], function () {
    return A(A.s = 87314);
  }), _N_E = A.O();
}]);