...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [3903],
  {
    63903: function (e, t, a) {
      ...
      async function g(e, { blockNumber: t, blockTag: a, data: s, to: n }) {
        let { args: o } = (0, l.p)({ data: s, abi: [m] }),
          [i, d, y, b, g] = o;
        try {
          if (
            !(function (e, t) {
              if (!(0, p.U)(e, { strict: !1 })) throw new h.b({ address: e });
              if (!(0, p.U)(t, { strict: !1 })) throw new h.b({ address: t });
              return e.toLowerCase() === t.toLowerCase();
            })(n, i)
          )
            throw new u({ sender: i, to: n });
          let s = await k({ data: y, sender: i, urls: d }),
            { data: o } = await (0, r.RE)(e, {
              blockNumber: t,
              blockTag: a,
              data: (0, w.zo)([
                b,
                (0, f.E)([{ type: "bytes" }, { type: "bytes" }], [s, g]),
              ]),
              to: n,
            });
          return o;
      ...
      async function k({ data: e, sender: t, urls: a }) {
