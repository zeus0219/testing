  ...
  [166],
  {
    ...
    23472: function (t, e, r) {
      ...
      var n = r(4079),
        ...
        c = { imageOptions: {}, ignoreUnknownTypes: !0 };
      function l(t) {
      ...
      t.exports = function (t, e, r, h) {
        var f = n({}, c, e),
          p = o(
            s(Array.isArray(f.blocks) ? f.blocks : [f.blocks]),
            f.listNestMode
          ),
          d = a(r, f.serializers || {}),
          ...
          g = p.map(function e(r, n, o, s) {
            ...
            return "list" === r._type && r.listItem
              ? ((a = r.listItem),
                (u = r.level),
                (c = r._key),
                (f = r.children.map(e)),
                t(d.list, { key: c, level: u, type: a, options: y }, f))
              : l(r)
              ? ((p = (function (t, e) {
                  for (var r = 0, n = 0; n < e.length && e[n] !== t; n++)
                    l(e[n]) && r++;
                  return r;
                })(r, o)),
                (m = r._key),
                ...
                t(
                  d.listItem,
                  { node: r, serializers: d, index: p, key: m, options: y },
                  g
                ))
              : "string" == typeof r || r.marks || "span" === r._type
              ? h(r, d, n, { serializeNode: e })
        ...
        if (m || g.length > 1) {
          var v = f.className ? { className: f.className } : {};
          return t(d.container, v, g);
        }
        return g[0]
          ? g[0]
          : "function" == typeof d.empty
          ? t(d.empty)
          : d.empty;
      };
    },
          ...
          e.forEach(function (t, e) {
            ...
            if (
              ...
              "span" === t._type &&
                ...
                (Array.isArray(t.marks) || void 0 === t.marks))
            ) {
    ...
    98317: function (t, e, r) {
      ...
      t.exports = function (t) {
        ...
        return i(o({ projectId: n, dataset: s }, r.imageOptions || {}))
          .image(e)
          .toString();
      };
    },
    ...
    36676: function (t, e, r) {
      ...
      t.exports = function (t, e) {
        return Object.keys(t).reduce(function (r, o) {
          ...
          return (
            "function" === s
              ? (r[o] = void 0 !== e[o] ? e[o] : t[o])
              : "object" === s
              ? (r[o] = i({}, t[o], e[o]))
              : (r[o] = void 0 === e[o] ? t[o] : e[o]),
            r
          );
        }, {});
      };
      ...
      t.exports = function (t) {
        for (
          ...
          if (l.level > e.level) {
            ...
            if ("html" === r) {
              var f = o(e),
                p = n({}, f, { children: f.children.concat(h) });
          ...
          if (l.listItem !== e.listItem) {
            var y = s(a[a.length - 1], { level: l.level });
        ...
        return {
          defaultSerializers: {
            ...
            block: function (e) {
              ...
              if (!u) {
                if (i.ignoreUnknownTypes)
                  return (
                    ...
                    t(n.unknownType, { node: r, options: i, isInline: o }, s)
                  );
                throw Error(
                  'Unknown block type "'.concat(
                    a,
              ...
              return t(u, { node: r, options: i, isInline: o }, s);
            },
            span: function (e) {
              var r = e.node,
                n = r.mark,
              ...
              return s
                ...
                : (console.warn(
                  ...
                  t(e.serializers.unknownMark, null, i));
            },
            hardBreak: function () {
              return t("br");
            },
          ...
          u = (function () {
            ...
            return (
              (c.withOptions = function (r) {
                ...
                return new u(this, t({ baseUrl: n }, o));
              }),
              (c.image = function (t) {
                ...
                return (function (e) {
                  ...
                  var a = (function (e) {
                    ...
                    if ("string" == typeof e && /^https?:\/\//.test("" + e))
                      r = { asset: { _ref: n(e) } };
                    else if ("string" == typeof e) r = { asset: { _ref: e } };
                    else if (e && "string" == typeof e._ref) r = { asset: e };
                    else if (e && "string" == typeof e._id)
                      r = { asset: { _ref: e._id || "" } };
                    else if (e && e.asset && "string" == typeof e.asset.url)
                      r = { asset: { _ref: n(e.asset.url) } };
                    else {
                      if ("object" != typeof e.asset) return null;
                      r = e;
                    }
                    return (
                      e.crop && (r.crop = e.crop),
                      e.hotspot && (r.hotspot = e.hotspot),
                      (function (e) {
                  ...
                  var u = (function (t) {
                      ...
                      return { id: n, width: c, height: l, format: o };
                    ...
                    h = {
                      ...
                      height: Math.round(
                        u.height - a.crop.bottom * u.height - l
                      ),
                    },
                  ...
                  return (
                      ...
                      (o = t(
                        ...
                        (function (t, e) {
                          var r,
                            ...
                            i = e.height;
                          if (!(n && i))
                            return { width: n, height: i, rect: t.crop };
                          var o = t.crop,
                            s = t.hotspot,
                            a = n / i;
                    ...
                    (function (t) {
                      ...
                      var h = [t.flipHorizontal && "h", t.flipVertical && "v"]
                        .filter(Boolean)
                        .join("");
                      ...
                      i.forEach(function (e) {
                        var r = e[0],
                          n = e[1];
                        void 0 !== t[r]
                          ? o.push(n + "=" + encodeURIComponent(t[r]))
                          : void 0 !== t[n] &&
    ...
    58446: function (t, e, r) {
      ...
      var n = r(2784),
        ...
        d = function t(e) {
          ...
          return h(
            p,
            Object.assign({}, c, e, { serializers: r, blocks: e.blocks || [] }),
            a,
            u
          );
        };
                        ...
                        (function (t, e) {
                          ...
                          if (o.width / o.height > a) {
                            ...
                            h < o.left
                              ...
                              : h + c > o.left + o.width &&
                                (h = o.left + o.width - c),
                              (r = { left: h, top: l, width: c, height: u });
                          } else {
                            var f = o.width,
                              p = Math.round(f / a),
                            ...
                            y < o.top
                              ...
                              : y + p > o.top + o.height &&
                                (y = o.top + o.height - p),
                              (r = { left: d, top: y, width: f, height: p });
                          }
                          return { width: n, height: i, rect: r };
                        })(
                          {
    ...
    53482: function (t, e, r) {
      ...
      let n = {
        ...
        i = function (t) {
          let e = { ...n, ...("string" == typeof t ? { url: t } : t) };
          if (
            ((e.timeout = (function t(e) {
              if (!1 === e || 0 === e) return !1;
              if (e.connect || e.socket) return e;
              let r = Number(e);
              return isNaN(r) ? t(n.timeout) : { connect: r, socket: r };
            })(e.timeout)),
            e.query)
          ) {
      ...
      let h = (t) =>
          function (e, r, ...n) {
            ...
            for (
              let r = 0;
              r < t[e].length && ((o = (0, t[e][r])(o, ...n)), !i || o);
              r++
            );
            return o;
          },
      ...
      var d,
        ...
        O = (t, e, r) => (
          C(t, e, "read from private field"), r ? r.call(t) : e.get(t)
        ),
        x = (t, e, r) => {
          if (e.has(t))
            throw TypeError(
        ...
        E = (t, e, r, n) => (
          C(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r
        );
      class k {
        constructor() {
          (this.readyState = 0),
        ...
        send(t) {
          ...
          "function" == typeof AbortController &&
            O(this, w) &&
            (E(this, v, new AbortController()),
            "u" > typeof EventTarget &&
              O(this, v).signal instanceof EventTarget &&
              (r.signal = O(this, v).signal)),
            "u" > typeof document &&
...
`
      ...
      let S = "function" == typeof XMLHttpRequest ? "xhr" : "fetch",
        ...
        I = (t, e) => {
          ...
          let a = new j();
          a instanceof k &&
            "object" == typeof i.fetch &&
            a.setInit(i.fetch, null == (r = i.useAbortSignal) || r);
          let u = i.headers,
            c = i.timeout,
            h = !1,
            f = !1,
          ...
          if (
            ((a.onerror = (t) => {
              m(
                Error(
                  `Request error while attempting to reach ${i.url}${
                    t.lengthComputable
            ...
            (a.ontimeout = (t) => {
              m(
                Error(
                  `Request timeout while attempting to reach ${i.url}${
                    t.lengthComputable
                      ? `(${t.loaded} of ${t.total} bytes transferred)`
                      : ""
                  }`
            ...
            (a.withCredentials = !!i.withCredentials),
            u && a.setRequestHeader)
          )
            for (let t in u) u.hasOwnProperty(t) && a.setRequestHeader(t, u[t]);
          return (
            i.rawBody && (a.responseType = "arraybuffer"),
          ...
          function m(t) {
            ...
            y(!0), (f = !0), (a = null);
            let r =
              t || Error(`Network error while attempting to reach ${i.url}`);
        ...
        _ = (t = [], e = I) =>
          (function t(e, r) {
            ...
            function s(t) {
              ...
              s("validateOptions", a);
              let u = { options: a, channels: i, applyMiddleware: s },
            ...
            return (
              (s.use = function (t) {
                ...
                if (t.onReturn && o.onReturn.length > 0)
                  throw Error(
      ...
      (q.source = () => {
        ...
        (F.Cancel = U),
        (F.CancelToken = q),
        (F.isCancel = (t) => !!(t && null != t && t.__CANCEL__));
      var z = (t, e, r) =>
        ...
        return {
          onError: (t, i) => {
            ...
            let c = Object.assign({}, i, {
              options: Object.assign({}, o, { attemptNumber: u + 1 }),
            });
        ...
        Q = {
          setTimeout: function (t, e) {
            ...
            return (null == i ? void 0 : i.setTimeout)
              ? i.setTimeout.apply(i, (0, L.ev)([t, e], (0, L.CR)(r)))
              : setTimeout.apply(void 0, (0, L.ev)([t, e], (0, L.CR)(r)));
          },
        ...
        return (
          ...
          (t.prototype.subscribe = function (t, e, r) {
            var n,
              ...
              o =
                ((n = t) && n instanceof to) ||
                (n && B(n.next) && B(n.error) && B(n.complete) && X(n))
                  ? t
                  : new tc(t, e, r);
            return (
              (function (t) {
                if (Z.useDeprecatedSynchronousErrorHandling) {
                  var e = !ti;
                  if ((e && (ti = { errorThrown: !1, error: null }), t(), e)) {
                    var r = ti,
                      n = r.errorThrown,
                      i = r.error;
                ...
                var t = i.operator,
                  e = i.source;
                o.add(
                  t ? t.call(o, e) : e ? i._subscribe(o) : i._trySubscribe(o)
                );
              }),
              o
            );
      ...
      function tg(t) {
        var e;
        return null !== (e = null != t ? t : Z.Promise) && void 0 !== e
          ? e
          : Promise;
      }
      var tv = function (t) {
      ...
      function tw(t) {
        return (
          ...
          B(null == t ? void 0 : t[Symbol.asyncIterator])
        );
      }
      function tC(t) {
        return TypeError(
      ...
      function tD() {
        ...
        return r
          ? (function () {
              ...
              tD.apply(void 0, (0, L.ev)([], (0, L.CR)(t))),
              tz(function (t) {
                return tN(t)
                  ? r.apply(void 0, (0, L.ev)([], (0, L.CR)(t)))
                  : r(t);
              })
            )
          : t_(function (e, r) {
              ...
              ((n = (0, L.ev)(
                [e],
                (0, L.CR)(1 === t.length && tq(t[0]) ? t[0] : t)
              )),
              void 0 === o && (o = td),
              function (t) {
                var e;
      ...
      function tB(t) {
        ...
        if (e.error && e.message)
          return (r.message = `${e.error} - ${e.message}`), r;
        if (
          tV(e) &&
          tV(e.error) &&
...
- `)}`
          ...
          return (
            t.length > 5 &&
              (i += `
...and ${t.length - 5} more`),
            (r.message = `${e.error.description}${i}`),
            (r.details = e.error),
            r
          );
        }
        return (
          e.error && e.error.description
            ? ((r.message = e.error.description), (r.details = e.error))
            : (r.message =
                e.error ||
                e.message ||
                (function (t) {
        ...
        tY = {
          onResponse: (t) => {
            ...
            return (
              (Array.isArray(e) ? e : [e])
                .filter(Boolean)
                .forEach((t) => console.warn(t)),
              t
            );
          },
        };
      function tG(t, { maxRetries: e = 5, retryDelay: r }) {
        var n;
        let i = _([
          e > 0 ? H({ retryDelay: r, maxRetries: e, shouldRetry: tX }) : {},
          ...t,
          tY,
          {
            processOptions: (t) => {
...
${e}`);
      ...
      let tZ = ["image", "file"],
        ...
        t3 = (t) => {
          if (-1 === tZ.indexOf(t))
            throw Error(
              `Invalid asset type: ${t}. Must be one of ${tZ.join(", ")}`
            );
        },
        t6 = (t, e) => {
      ...
      var t7 = (t, e, r) => {
        ...
        et = (t, e, r) => (
          t7(t, e, "read from private field"), r ? r.call(t) : e.get(t)
        ),
        ee = (t, e, r) => {
          if (e.has(t))
            throw TypeError(
        ...
        er = (t, e, r, n) => (
          t7(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r
        );
      class en {
        constructor(t, e = {}) {
        ...
        insert(t, e, r) {
          return t5(t, e, r), this._assign("insert", { [t]: e, items: r });
        }
        append(t, e) {
        ...
        serialize() {
          return { ...tK(this.selection), ...this.operations };
        }
        toJSON() {
      ...
      let ei = class t extends en {
        ...
        clone() {
          return new t(this.selection, { ...this.operations }, et(this, eZ));
        }
        commit(t) {
          if (!et(this, eZ))
            throw Error(
          ...
          return et(this, eZ).mutate({ patch: this.serialize() }, e);
        }
      };
      eZ = new WeakMap();
      let eo = class t extends en {
        ...
        clone() {
          return new t(this.selection, { ...this.operations }, et(this, eQ));
        }
        commit(t) {
          if (!et(this, eQ))
            throw Error(
          ...
          return et(this, eQ).mutate({ patch: this.serialize() }, e);
        }
      };
      eQ = new WeakMap();
      var es = (t, e, r) => {
        ...
        ea = (t, e, r) => (
          es(t, e, "read from private field"), r ? r.call(t) : e.get(t)
        ),
        eu = (t, e, r) => {
          if (e.has(t))
            throw TypeError(
        ...
        ec = (t, e, r, n) => (
          es(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r
        );
      let el = { returnDocuments: !1 };
      class eh {
        constructor(t = [], e) {
          (this.operations = t), (this.trxId = e);
        }
        create(t) {
          return t6("create", t), this._add({ create: t });
        }
        createIfNotExists(t) {
          let e = "createIfNotExists";
          return t6(e, t), t9(e, t), this._add({ [e]: t });
        }
        createOrReplace(t) {
        ...
        delete(t) {
          return t2("delete", t), this._add({ delete: { id: t } });
        }
        transactionId(t) {
      ...
      let ef = class t extends eh {
        ...
        commit(t) {
          ...
          return ea(this, e0).mutate(
            this.serialize(),
            Object.assign({ transactionId: this.trxId }, el, t || {})
          );
        }
        patch(t, e) {
          let r = "function" == typeof e;
          if ("string" != typeof t && t instanceof eo)
      ...
      let ep = class t extends eh {
        ...
        patch(t, e) {
          let r = "function" == typeof e;
          if ("string" != typeof t && t instanceof ei)
            return this._add({ patch: t.serialize() });
          if (r) {
      ...
      let ey = (t) => {
        ...
        ek = (t, e) => {
          ...
          if (
            ("string" == typeof n.perspective && eE(n.perspective),
      ...
      var eS = {
        ...
        ej = { 0: 8203, 1: 8204, 2: 8205, 3: 65279 },
        eI = [, , , ,].fill(String.fromCodePoint(ej[0])).join("");
      function e_(t, e, r = "auto") {
        let n;
        return !0 === r ||
          ("auto" === r &&
            ((Number.isNaN(Number(t)) && Date.parse(t)) ||
              (function (t) {
                try {
              ...
              `${eI}${Array.from(n)
                .map((t) => {
                  ...
                  return Array.from(e.toString(4).padStart(4, "0"))
                    .map((t) => String.fromCodePoint(ej[t]))
                    .join("");
                })
                .join("")}`)
            }`;
      }
      Object.fromEntries(Object.entries(ej).map((t) => t.reverse())),
        Object.fromEntries(Object.entries(eS).map((t) => t.reverse()));
      var eT = `${Object.values(eS)
          .map((t) => `\\u{${t.toString(16)}}`)
          .join("")}`,
        eM = RegExp(`[${eT}]{4,}`, "gu");
      let eA = ({ query: t, params: e = {}, options: r = {} }) => {
          let n = new URLSearchParams(),
            { tag: i, returnQuery: o, ...s } = r;
      ...
      function ez(t, e, r, n = {}) {
        let i = { uri: eG(t, "doc", r), json: !0, tag: n.tag };
        return eJ(t, e, i).pipe(
          tW(eP),
          tz((t) => t.body.documents && t.body.documents[0])
        );
      }
      function eN(t, e, r, n = {}) {
        let i = { uri: eG(t, "doc", r.join(",")), json: !0, tag: n.tag };
        return eJ(t, e, i).pipe(
          tW(eP),
          tz((t) => {
      ...
      function eH(t, e, r, n) {
        return eB(t, e, "mutate", { mutations: [{ delete: tK(r) }] }, n);
      }
      function eL(t, e, r, n) {
        let i;
        return eB(
          ...
          "mutate",
          {
            mutations: Array.isArray(
              (i =
                r instanceof eo || r instanceof ei
                  ? { patch: r.serialize() }
                  : r instanceof ef || r instanceof ep
                  ? r.serialize()
                  : r)
            )
              ? i
      ...
      function eB(t, e, r, n, i = {}) {
        let o = "mutate" === r,
          ...
          a = !o && s.length < 11264,
          u = i.returnFirst,
          { timeout: c, token: l, tag: h, headers: f, returnQuery: p } = i,
          d = eG(t, r, a ? s : "");
        return eJ(t, e, {
          method: a ? "GET" : "POST",
          uri: d,
          ...
          tz((t) => {
            ...
            if (i.returnDocuments)
              return u ? e[0] && e[0].document : e.map((t) => t.document);
      ...
      function eJ(t, e, r) {
        ...
        let s = r.url || r.uri,
          ...
          l =
            r.tag && a.requestTagPrefix
              ? [a.requestTagPrefix, r.tag].join(".")
              : r.tag || a.requestTagPrefix;
        if (
          (l && null !== r.tag && (r.query = { tag: t8(l), ...r.query }),
          ...
          "string" == typeof e &&
            "raw" !== e &&
            (eE(e),
            (r.query = { perspective: e, ...r.query }),
            "previewDrafts" === e && c && ((c = !1), eg())),
            !1 === r.returnQuery &&
        ...
        let h = (function (t, e = {}) {
          ...
          })(a, Object.assign({}, r, { url: eX(t, s, c) })),
                      ...
                      (function (t) {
                        ...
                        if (eK)
                          return new DOMException(
                            null != (e = null == t ? void 0 : t.reason)
                              ? e
                              : "The operation was aborted.",
                            "AbortError"
                          );
                        let n = Error(
                          null != (r = null == t ? void 0 : t.reason)
                            ? r
                            : "The operation was aborted."
                        );
      ...
      var eZ,
        ...
        e9 = (t, e, r) => (
          e2(t, e, "read from private field"), r ? r.call(t) : e.get(t)
        ),
        e5 = (t, e, r) => {
          if (e.has(t))
            throw TypeError(
        ...
        e4 = (t, e, r, n) => (
          e2(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r
        );
      class e8 {
        constructor(t, e) {
          e5(this, e3, void 0),
      ...
      class e7 {
        ...
        upload(t, e, r) {
          return tU(
            rt(e9(this, ra), e9(this, ru), t, e, r).pipe(
              tW((t) => "response" === t.type),
              tz((t) => t.body.document)
            )
          );
        }
      }
      ...
      function ro(t, e, n = {}) {
        let {
          ...
          c = { ...re(n, ri), tag: u },
          l = eA({ query: t, params: e, options: { tag: u, ...rr(c, rn) } }),
          h = `${i}${eG(this, "listen", l)}`;
        if (h.length > 14800)
          return new tm((t) => t.error(Error("Query too large for listener")));
        let f = c.events ? c.events : ["mutation"],
          p = -1 !== f.indexOf("reconnect"),
          d = {};
        return (
          (o || s) && (d.withCredentials = !0),
          o && (d.headers = { Authorization: `Bearer ${o}` }),
          new tm((t) => {
            let e;
            l()
              .then((t) => {
            ...
            function o() {
              i ||
                (p && t.next({ type: "reconnect" }),
                i ||
                  e.readyState !== e.CLOSED ||
                  (c(), clearTimeout(n), (n = setTimeout(y, 100))));
            }
            function s(e) {
              t.error(
                (function (t) {
            ...
            function c() {
              e &&
                ...
                e.removeEventListener("channelError", s),
                e.removeEventListener("disconnect", u),
                f.forEach((t) => e.removeEventListener(t, a)),
                e.close());
            }
            async function l() {
              let { default: t } = await r.e(704).then(r.t.bind(r, 83014, 19)),
                e = new t(h, d);
              return (
                e.addEventListener("error", o),
                e.addEventListener("channelError", s),
                e.addEventListener("disconnect", u),
                f.forEach((t) => e.addEventListener(t, a)),
                e
              );
            }
            function y() {
      ...
      function rs(t) {
        try {
          ...
          return Object.assign({ type: t.type }, e);
        } catch (t) {
          return t;
        }
      }
      var ra,
        ...
        rf = (t, e, r) => (
          rh(t, e, "read from private field"), r ? r.call(t) : e.get(t)
        ),
        rp = (t, e, r) => {
          if (e.has(t))
            throw TypeError(
        ...
        rd = (t, e, r, n) => (
          rh(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r
        );
      class ry {
        constructor(t, e) {
          rp(this, rc, void 0),
      ...
      class rm {
        ...
        list() {
          return tU(
            eY(rf(this, rv), rf(this, rb), { uri: "/datasets", tag: null })
          );
        }
      }
      function rg(t, e, r, n, i) {
        return (
          t0(n),
          eY(t, e, { method: r, uri: `/datasets/${n}`, body: i, tag: null })
        );
      }
      ...
      var rv,
        ...
        rx = (t, e, r) => (
          rO(t, e, "read from private field"), r ? r.call(t) : e.get(t)
        ),
        rE = (t, e, r) => {
          if (e.has(t))
            throw TypeError(
        ...
        rk = (t, e, r, n) => (
          rO(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r
        );
      class rS {
        constructor(t, e) {
          rE(this, rw, void 0),
        ...
        list(t) {
          let e =
            (null == t ? void 0 : t.includeMembers) === !1
              ? "/projects?includeMembers=false"
              : "/projects";
          return eY(rx(this, rw), rx(this, rC), { uri: e });
        }
        getById(t) {
          return eY(rx(this, rw), rx(this, rC), { uri: `/projects/${t}` });
        }
      }
        ...
        list(t) {
          let e =
            (null == t ? void 0 : t.includeMembers) === !1
              ? "/projects?includeMembers=false"
              : "/projects";
          return tU(eY(rx(this, rI), rx(this, r_), { uri: e }));
        }
        getById(t) {
          return tU(eY(rx(this, rI), rx(this, r_), { uri: `/projects/${t}` }));
        }
      }
      ...
      var rI,
        ...
        r$ = (t, e, r) => (
          rA(t, e, "read from private field"), r ? r.call(t) : e.get(t)
        ),
        rR = (t, e, r) => {
          if (e.has(t))
            throw TypeError(
        ...
        rP = (t, e, r, n) => (
          rA(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r
        );
      class rF {
        constructor(t, e) {
          rR(this, rT, void 0),
        ...
        getById(t) {
          return eY(r$(this, rT), r$(this, rM), { uri: `/users/${t}` });
        }
      }
      ...
      class rU {
        ...
        getById(t) {
          return tU(eY(r$(this, rq), r$(this, rz), { uri: `/users/${t}` }));
        }
      }
      ...
      var rq,
        ...
        rH = (t, e, r) => (
          rW(t, e, "read from private field"), r ? r.call(t) : e.get(t)
        ),
        rL = (t, e, r) => {
          if (e.has(t))
            throw TypeError(
        ...
        rB = (t, e, r, n) => (
          rW(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r
        );
      let rV = class t {
        constructor(t, e = eC) {
          rL(this, rN, void 0),
            ...
            this.config(e),
            rB(this, rD, t),
            (this.assets = new e8(this, rH(this, rD))),
            (this.datasets = new ry(this, rH(this, rD))),
            (this.projects = new rS(this, rH(this, rD))),
            (this.users = new rF(this, rH(this, rD)));
        }
        clone() {
          return new t(rH(this, rD), this.config());
        }
        config(t) {
          if (void 0 === t) return { ...rH(this, rN) };
          if (rH(this, rN) && !1 === rH(this, rN).allowReconfigure)
            throw Error(
      ...
      let rJ = class t {
        constructor(t, e = eC) {
          rL(this, u, void 0),
            ...
            this.config(e),
            rB(this, c, t),
            (this.assets = new e7(this, rH(this, c))),
            (this.datasets = new rm(this, rH(this, c))),
            (this.projects = new rj(this, rH(this, c))),
            (this.users = new rU(this, rH(this, c))),
            (this.observable = new rV(t, e));
        }
        clone() {
          return new t(rH(this, c), this.config());
        }
        config(t) {
          if (void 0 === t) return { ...rH(this, u) };
          if (rH(this, u) && !1 === rH(this, u).allowReconfigure)
            throw Error(
              "Existing client instance cannot be reconfigured - use `withConfig(newConfig)` to return a new client"
            );
          return (
            this.observable && this.observable.config(t),
            rB(this, u, ek(t, rH(this, u) || {})),
            this
          );
        }
        withConfig(e) {
      ...
      function rG(t, e) {
        return {
          ...
          createClient: (r) =>
            new e(
              tG(t, { maxRetries: r.maxRetries, retryDelay: r.retryDelay }),
              r
            ),
        };
      }
    ...
    60058: function (t, e, r) {
      ...
      let d = (t) => {
        ...
        return (
          !(
            ("slug" === e.at(-2) && "current" === r) ||
            ("string" == typeof r && r.startsWith("_"))
          ) &&
          ("number" != typeof r ||
            "marks" !== e.at(-2) ||
            "number" != typeof e.at(-3) ||
            "children" !== e.at(-4) ||
            "number" != typeof e.at(-5)) &&
          ("href" !== r ||
            "number" != typeof e.at(-2) ||
            "markDefs" !== e.at(-3) ||
            "number" != typeof e.at(-4)) &&
          ("string" != typeof r ||
            "number" != typeof e.at(-2) ||
            ("style" !== r && "listItem" !== r))
        );
      ...
      let m = (t) => {
        ...
        try {
          if (m && !1 !== t.resultSourceMap) {
            ...
            let e = (function (t) {
              let { studioUrl: e, encodeSourceMapAtPath: r, logger: n } = t;
              !(function (t, e) {
              ...
              return (
                i.use(
                    ...
                    let {
                      ...
                      i = (function (t, e, r) {
                        let n = (function (t) {
                          ...
                          o = (t, o, s) =>
                            ("function" == typeof e
                              ? e({ path: s, filterDefault: d })
                              : d({ path: s, filterDefault: d })) === !1
                              ? (r &&
                                  i.skipped.push({
                                    path: y(s),
                                    value: ""
                                    ...
                                    : `${t}${(function (t) {
                                        ...
                                        return Array.from(e)
                                          .map((t) => {
                                            ...
                                            if (r > 255)
                                              throw Error(
                                                `Only ASCII edit info can be encoded. Error attempting to encode ${e} on character ${t} (${r})`
                                              );
                                            return Array.from(
                                              r.toString(16).padStart(2, "0")
                                            )
                                              .map((t) =>
                                                String.fromCodePoint(u[t])
                                              )
                                              .join("");
                                          })
                                          .join("");
                        ...
                        return {
                          ...
                          walk: (t) => (
                            ...
                            (i.skipped.length = 0),
                            (function (t, e) {
                              if (!t.resultSourceMap)
                                throw TypeError("Missing resultSourceMap");
                              return (
                                (t.result = (function t(e, r) {
                                  let n =
                                    arguments.length > 2 &&
                                    void 0 !== arguments[2]
                                      ? arguments[2]
                                  ...
                                  let i = (function (t, e, r) {
                                    ...
                                    if (!e.mappings) {
                                      null == r ||
                                        r.error(
                                          "Missing resultSourceMap.mappings",
                                          { resultSourceMap: e }
                                        );
                                      return;
                                    }
                                    if (void 0 !== e.mappings[n])
                                      return [e.mappings[n], n, ""];
                                    let i = Object.entries(e.mappings)
                                      .filter((t) => {
                                        let [e] = t;
                                  ...
                                  if (
                                    "value" !== o.type ||
                                    "documentValue" !== o.source.type
                                  )
                                    return r;
                                  let a =
                                    t.resultSourceMap.documents[
                                      o.source.document
                                    ];
                                  return e(
                                    r,
                                    a,
                                    t.resultSourceMap.paths[o.source.path] + s
                                  );
                                })),
                                t
                              );
                          ...
                          if (n) {
                            ...
                            if (
                              ((t || e) &&
                                ...
                                null == n ||
                                  n.log(
                                    "[@sanity/preview-kit]: Paths encoded: "
                                      .concat(
                                        i.report.encoded.length,
                                        ", skipped: "
                                      )
                                      .concat(i.report.skipped.length)
                                  )),
                              i.report.encoded.length > 0 &&
                                (null == n ||
                                  n.log(
                                    "[@sanity/preview-kit]: Table of encoded paths"
                                  ),
                                null == n || n.table(i.report.encoded)),
                              i.report.skipped.length > 0)
                            ) {
                              let t = new Set();
                              for (let { path: e } of i.report.skipped)
                                t.add(e.replace(/\[\d+\]/g, "[]"));
                              null == n ||
                                n.log(
                  ...
                  })({ studioUrl: e, encodeSourceMapAtPath: r, logger: n })
                ),
                (s.defaultRequester = i),
                s
              );
            })({ ...t, studioUrl: i });
            return new n.S(e, { ...f, resultSourceMap: !0 });
          }
        } catch (t) {
          console.error(
      ...
      function v(t) {
        ...
        return m({ ...t, studioUrl: e, encodeSourceMap: r });
      }
    },
